...
export const MOCK_CITED_ART_DETAILS: Record<string, CitedArtDetail> = {
  인용발명1: {
    ...
    title: '카본블랙-고무 복합체의 제조방법 및 이를 이용한 타이어',
    applicant: '주식회사 한국타이어',
    filing_date: '2014-03-14',
    abstract:
      '본 발명은 카본블랙 분산액과 고무 라텍스를 혼합하고 염산 응집제를 첨가하여 응집물을 형성한 후, 원심분리로 분리하고 건조하는 웨트 마스터배치 제조방법에 관한 것이다. 본 발명은 카본블랙의 분산성을 향상시켜 타이어의 내마모성 및 연비를 개선하는 것을 목적으로 한다.',
    key_claims: [
      {
        claim_number: 1,
        text: '카본블랙 분산액과 고무 라텍스를 혼합하여 혼합물을 제조하는 단계; 상기 혼합물에 염산을 응집제로 첨가하여 응집물을 형성하는 단계; 상기 응집물을 원심분리하여 분리하는 단계; 및 상기 분리된 응집물을 건조하는 단계;를 포함하는 카본블랙-고무 복합체의 제조방법.',
      },
      {
        claim_number: 2,
        text: '제1항에 있어서, 상기 카본블랙 분산액의 pH는 6~8인 것을 특징으로 하는 카본블랙-고무 복합체의 제조방법.',
      },
    ],
    relevant_paragraphs: [
      {
        paragraph_id: '0023',
        text: '[0023] 카본블랙 분산액과 천연 고무 라텍스를 중량비 1:4로 혼합하여 혼합물을 제조하였다. 혼합은 상온(25°C)에서 교반기를 이용하여 30분간 수행하였다.',
      },
      {
        paragraph_id: '0031',
        text: '[0031] 상기 혼합물에 5wt% 염산 수용액을 서서히 첨가하여 pH 4.5로 조정함으로써 응집물을 형성하였다. 형성된 응집물의 평균 입경은 200~500μm였다.',
      },
      {
        paragraph_id: '0038',
        text: '[0038] 분리된 응집물을 열풍 건조기에서 80°C, 2시간 건조하여 최종 웨트 마스터배치를 제조하였다. 건조 후 수분 함량은 0.5% 이하였다.',
      },
    ],
  },
  인용발명2: {
    cited_art_id: '인용발명2',
    document_number: '10-2013-0098123',
    title: '나노 카본블랙을 이용한 고무 복합재료 및 그 제조방법',
    applicant: '한국화학연구원',
    filing_date: '2013-08-19',
    abstract:
      '본 발명은 평균 입경 10nm~200nm의 나노 카본블랙을 분산매에 분산시킨 분산액을 이용하여 고무 복합재료를 제조하는 방법에 관한 것으로, 나노 입자 특성을 활용하여 고무의 기계적 물성을 현저히 향상시키는 기술을 제공한다.',
    key_claims: [
      {
        claim_number: 1,
        text: '평균 입경이 10nm~200nm인 나노 카본블랙을 물에 분산시킨 분산액을 제조하는 단계; 상기 분산액과 합성 고무 라텍스를 혼합하는 단계; 및 혼합물을 공침시켜 고무 복합재료를 제조하는 단계;를 포함하는 나노 카본블랙-고무 복합재료의 제조방법.',
      },
      {
        claim_number: 3,
        text: '제1항에 있어서, 상기 나노 카본블랙의 BET 비표면적은 100~500m²/g인 것을 특징으로 하는 나노 카본블랙-고무 복합재료의 제조방법.',
      },
    ],
    relevant_paragraphs: [
      {
        paragraph_id: '0015',
        text: '[0015] 본 발명에서 사용되는 나노 카본블랙은 평균 입경이 10nm~200nm인 것이 바람직하다. 입경이 10nm 미만이면 응집이 심하여 분산이 어렵고, 200nm를 초과하면 나노 입자로서의 특성이 감소한다.',
      },
      {
        paragraph_id: '0021',
        text: '[0021] 나노 카본블랙 분산액과 SBR 라텍스를 중량비 1:3으로 혼합하고 황산마그네슘 수용액을 첨가하여 공침시켰다. 공침 온도는 특별히 한정되지 않으나 상온에서 수행하는 것이 경제적이다.',
      },
    ],
  },
};
